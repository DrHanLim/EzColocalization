...
public interface PluginConstants {
	...
	public static final int DO_CEN2NPOLE = 512;
	public static final int DO_CEN2CEN = 0;

	// Choose how to determine particles
	public static final int DO_DIST_THOLD = 1024;
	public static final int DO_DIST_FT = 2048;
	...
	public static final int RUN_DIST = DO_CEN2NPOLE | DO_CEN2CEN;
	public static final int RUN_TOSHM = DO_TOS;
	public static final int RUN_TOS = DO_TOS | DO_MATRIX;
	public static final int RUN_METRICS = DO_TOS | DO_PCC | DO_SRC | DO_AVGINT | DO_MCC | DO_ICQ | DO_MCC | DO_CUSTOM;
	public static final int RUN_METRICS_TOS = RUN_METRICS | RUN_TOSHM;
	public static final int RUN_CDP = RUN_DIST | RUN_TOS | RUN_METRICS | RUN_SCATTER;
	public static final int RUN_IDCELLS = RUN_CDP | DO_HEAT_CELL | DO_MASKS | DO_ROIS;
	public static final int RUN_OUTPUT = DO_SUMMARY;
	public static final int RUN_RTS = DO_RESULTTABLE | DO_HIST | RUN_OUTPUT;
	...
	public static final int OPTS_DIST = DO_DIST_THOLD | DO_DIST_FT;
	public static final int OPTS_OUTPUT = DO_RESULTTABLE | DO_SUMMARY | DO_HIST | DO_HIST | DO_CUSTOM;

	public static final int RQD_REPORTER = RUN_HEAT | DO_AVGINT | RUN_DIST | DO_CUSTOM;
	public static final int RQD_ALL_REPORTERS = RUN_TOS | RUN_SCATTER | DO_PCC | DO_SRC | DO_MCC | DO_ICQ | DO_MATRIX;
	public static final int RQD_CELLID = RUN_ALIGN | RUN_DIST | DO_HEAT_CELL | DO_MASKS | DO_ROIS;

	// Parameters
	public static final int DEFAULT_MIN_FT = 1;
	public static final int DEFAULT_MAX_FT = 99;
	public static final double PHASE_ROLINGBALL_SIZE = 25.0;
