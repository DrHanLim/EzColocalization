...
public class ScatterPlotGenerator{
	...
	public ScatterPlotGenerator(String title, String xLabel, String yLabel, float[][] xValues, float[][] yValues, String[] sliceLabels){
	...
	public ScatterPlotGenerator(String title, String xLabel, String yLabel, float[][] xValues, float[][] yValues, String[] sliceLabels, int flags){
	...
	public ScatterPlotGenerator(String title, String[] xLabels, String[] yLabels, float[][] xValues, float[][] yValues, String[] sliceLabels, int flags){
		if(yValues!=null && yValues.length>0){
			nPlots = yValues.length;
			plots = new Plot[nPlots];
			this.title=title;
	...
	/**
	 * This part of code mimics that of ImageStack addSlice
	 * Maybe because of performance, the array length is increase by 2-fold at each out-of-bound event
	 * @param sliceLabel
	 * @param xLabel
	 * @param yLabel
	 * @param xValues
	...
	private void addPlot(String xLabel, String yLabel, float[] xValues, float[] yValues, String sliceLabel, int iSlice)
	{
		if(plots==null)
			return;
		...
		//Plot bug: the plot cannot automatically generate if there is only one data point
	...
	private void addPlots(String[] xLabels, String[] yLabels, float[][] xValues, float[][] yValues, String[] sliceLabels)
	{
