...
public class HistogramGenerator {
	...
	public void addToHistogramStack(String name, double[] tempResult) {
		...
		// This number of bins algorithm doesn't work make a fixed 10 bins
		// nBins=(int)
		// (getRange(tempResult)/(2*quartile(tempResult,25,75)*Math.pow(tempResult.length,
		// -1.0/3.0)));
	...
	public HistogramStackWindow getWindow() {
		return stackhistWindow;
	}

	/**
	 * @deprecated Freedman¨CDiaconis rule is used here to calculate the number
	 *             of bins This has been replaced by HistogramStackWindow
	 */
	 ...
	 * Retrivethequartilevaluefromanarray.htm
	 */
